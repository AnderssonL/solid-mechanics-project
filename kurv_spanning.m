function [normal, vrid, skjuv] = kurv_spanning(d, D, N_points, b_b, b_1, b_d, L, N_b, F_b, M_b1, M_k, H_i, V_i, V_y, R_ix, R_iz, R_yz, F_k, A, a, I, i, K, k)
    ...
    for i = 1:N_points
        ...
        elseif L-b_1<y && y<=L-b_b
            normal(i) = (H_i/a) + d*(R_iz*b_1+R_yz*(L-b_1)+V_y*y)/(i);
            vrid(i)   = 0;
            skjuv(i)  = (4*V_i)/(3*a);
