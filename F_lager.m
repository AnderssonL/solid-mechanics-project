function [R_yx, R_ix, R_yz, R_iz, R_iy, F_k, F_b] = F_lager(m, L, b_1, r_hjul, r_b, r_d, b_b, b_d, a1, a2, Cd, rho_luft, v, styrVariabel, H_bi, H_by, V_bi, V_by, F_d)
...
%Momentekvationer
Mx = (L/2)*(V_bi-V_by) + (r_hjul)*(H_bi+H_by) + (L/2-b_1)*(R_iz-R_yz) == 0;

%My = (-F_d*r_hjul) - 2*F_b*r_b + F_k*r_d == 0;
